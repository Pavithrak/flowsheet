 ...
 */
@Controller
@RequestMapping(value = "module/flowsheetmodule/flowsheetmoduleLink.form")
public class FlowsheetModuleFormController{
	
	/** Logger for this class and subclasses */
	protected final Log log = LogFactory.getLog(getClass());
	
	/** Success form view name */
	private final String SUCCESS_FORM_VIEW = "/module/flowsheetmodule/flowsheetmoduleForm";
